 ...
 */
class DanisBegishevCode implements Player {
    ...
    public int[] bestField(int A, int B, int C) {
        ...
        int[] ans = new int[2];
        if (maxx == A) {ans[0] = 1; ans[1] = A; return ans;};
        if (maxx == B) {ans[0] = 2; ans[1] = B; return ans;};
        if (maxx == C) {ans[0] = 3; ans[1] = C; return ans;};
        return ans;
    }
    ...
    public int[] secondBestField(int A, int B, int C) {
        ...
        int ans[] = new int[2];
        if (secondBest == C) {ans[0] = 3; ans[1] = C; return ans;}
        if (secondBest == B) {ans[0] = 2; ans[1] = B; return ans;}
        if (secondBest == A) {ans[0] = 1; ans[1] = A; return ans;}
